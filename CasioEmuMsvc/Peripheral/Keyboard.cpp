...
namespace casioemu {
	void Keyboard::Initialise() {
		...
		if (emulator.hardware_id == HW_5800P) {
			region_ko.Setup(
				0xF044, 1, "Keyboard/KO", this, [](MMURegion* region, size_t offset) {
			offset -= region->base;
			Keyboard* keyboard = ((Keyboard*)region->userdata);
			return (uint8_t)(keyboard->keyboard_out & 0xFF); }, [](MMURegion* region, size_t offset, uint8_t data) {
				offset -= region->base;
				Keyboard* keyboard = ((Keyboard*)region->userdata);
		...
		if (!real_hardware) {
			...
			region_ready_emu.Setup(
				offset + 0x8E00, 1, "Keyboard/ReadyStatusEmulator", this, [](MMURegion* region, size_t offset) {
				Keyboard* keyboard = ((Keyboard*)region->userdata);
				return keyboard->keyboard_ready_emu; }, [](MMURegion* region, size_t offset, uint8_t data) {
					Keyboard* keyboard = ((Keyboard*)region->userdata);
					if (data == 8) {
					...
					keyboard->keyboard_ready_emu = data; }, emulator);
			region_ki_emu.Setup(
				offset + 0x8E01, 1, "Keyboard/KIEmulator", this, [](MMURegion* region, size_t offset) {
					Keyboard* keyboard = ((Keyboard*)region->userdata);
			...
			region_ko_emu.Setup(
				offset + 0x8E02, 1, "Keyboard/KOEmulator", this, [](MMURegion* region, size_t offset) {
					Keyboard* keyboard = ((Keyboard*)region->userdata);
