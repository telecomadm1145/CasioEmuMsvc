...
The code is built directly as part of CasioEmuMsvc and has no build-time or
run-time dependency on the sibling reference checkout. The C++ integration
boundary is Chipset/ePSCpu.h.
