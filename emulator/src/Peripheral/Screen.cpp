...
namespace casioemu
{
	...
	template<bool val, class T1, class T2>
	using branch_t = TypeBranch<val,T1, T2>::Type;
	...
	class Screen : public Peripheral
	{
		...
		using Sprite = 
			branch_t<hardware_id == HardwareId::HW_CLASSWIZ_II,
				cwii_sprite, 
				branch_t<hardware_id == HardwareId::HW_CLASSWIZ, clswiz_sprite, esplus_sprite>
				>;
